...
/** batchEditUpload POST /api/picture/edit/batch */
export async function batchEditUploadUsingPost(
...
/** queryAiPaintingTask GET /api/picture/out_painting/get_task */
export async function queryAiPaintingTaskUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.queryAiPaintingTaskUsingGETParams,
  options?: { [key: string]: any }
) {
